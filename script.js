...
// Close buttons for all sheets and panels
document.getElementById("dateSheetClose").onclick = function(){ closeAllSheets(); };
document.getElementById("typeSheetClose").onclick = function(){ closeAllSheets(); };
document.getElementById("trailSheetClose").onclick = function(){ closeAllSheets(); };
document.getElementById("shareBoxClose").onclick = function(){ document.getElementById("shareOverlay").classList.remove("show"); };
document.getElementById("searchPanelClose").onclick = function(){ document.getElementById("searchPanel").classList.remove("show"); };
